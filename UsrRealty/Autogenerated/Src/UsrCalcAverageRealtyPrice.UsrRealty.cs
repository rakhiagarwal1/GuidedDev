namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageRealtyPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageRealtyPriceMethodsWrapper : ProcessModel
	{

		public UsrCalcAverageRealtyPriceMethodsWrapper(Process process)
			: base(process) {
